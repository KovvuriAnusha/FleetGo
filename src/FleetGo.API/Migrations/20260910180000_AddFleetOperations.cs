...
namespace FleetGo.API.Migrations
{
    ...
    public partial class AddFleetOperations : Migration
    {
        ...
        {
            // OtpCodes (Phase 3) was never migrated - the OtpCode entity and its
            // configuration have existed since Phase 3, but no migration was ever generated
            // for it (see docs/roadmap.md). This migration is a diff against the last real
            // migration (InitialAuth), so it necessarily picks up that pending table too.
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RouteNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpCodes_UserId_Purpose_CreatedAtUtc",
                table: "OtpCodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_DriverId_RouteDate",
                table: "Routes",
                columns: new[] { "DriverId", "RouteDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stops_RouteId_Sequence",
                table: "Stops",
